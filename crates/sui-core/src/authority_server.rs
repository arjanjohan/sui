...
impl ValidatorService {
    ...
    async fn handle_submit_transaction(
        ...
        // TODO(arun): Skip checking for execution effects
        ...
        .and_then(|(resp, spam_weight)| {
            ...
            let submit_transaction_response =
                RawSubmitTxResponse::into_raw(transaction_response.consensus_position)?;
    ...
    async fn handle_get_effects(
        ...
        .and_then(|(resp, spam_weight)| {
            ...
            let submit_transaction_response = RawGetEffectsResponse::into_raw(
    ...
    async fn handle_submit_to_consensus_for_position(
        ...
        epoch_store: &Arc<AuthorityPerEpochStore>,
    ) -> Result<(ConsensusPosition, Weight), tonic::Status> {
        let consensus_transactions: Vec<_> = consensus_transactions.into();
        {
            ...
            if !epoch_store.all_external_consensus_messages_processed(
                ...
                return Err(SuiError::TransactionAlreadyExecuted { digest: () }c.into())
            }
        }
